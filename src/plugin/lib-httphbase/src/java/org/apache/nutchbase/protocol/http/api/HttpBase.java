 ...
 */
package org.apache.nutchbase.protocol.http.api;
 ...
 */
public abstract class HttpBase implements ProtocolHbase {
  ...
  public ProtocolOutput getProtocolOutput(String url, RowPart row) {
...
//    }
    ...
    ProtocolOutput out = http.getProtocolOutput(url, new RowPart());
  ...
  public RobotRules getRobotRules(String url, ImmutableRowPart row) {

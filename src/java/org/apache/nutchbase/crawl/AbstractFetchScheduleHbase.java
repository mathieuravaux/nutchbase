 ...
 */
public abstract class AbstractFetchScheduleHbase
extends Configured
implements FetchScheduleHbase {
  private static final Log LOG = LogFactory.getLog(AbstractFetchScheduleHbase.class);
  ...
  public AbstractFetchScheduleHbase() {
    super(null);
  }
  
  public AbstractFetchScheduleHbase(Configuration conf) {
    super(conf);
  }
